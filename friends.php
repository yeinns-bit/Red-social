	...
	?><div class="row">    
            <div class="col-md-2 text-center">
             <img  src="<?php echo $friend_image; ?>" style="width:100px;height:100px" class="img-circle"></a>
				...
				<div class="col-md-10">
					<div class="pull-right"><a href="delete_friend.php<?php echo '?id='.$id; ?>" class="btn btn-danger"><i class="icon-remove"></i>  No es mi amigo </a>
						<a href="friend_photos.php?friend_id=<?php echo $row['member_id']; ?>" class="btn btn-primary" style="margin-left:10px;"><i class="icon-picture"></i> Ver Fotos</a></div>
